package io.egan.Weather_rest.Controller;
...
import io.egan.Weather_rest.Constants.URI;
...
public class WeatherController {
	...
	public Weather findLatestCityWeather(@PathVariable("city") String city) {
		return weatherservice.findLatestCityWeather(city);
	}
	...
	public String findLatestWeatherProperty(@PathVariable("city") String city, @PathVariable("param") String param) {
		return weatherservice.findLatestWeatherProperty(city, param);
	}
